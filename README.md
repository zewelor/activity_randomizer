...
Simply open the `index.html` file in your web browser, no server required. The JavaScript is now written as an ES module for better maintainability, so make sure you use a modern browser.
